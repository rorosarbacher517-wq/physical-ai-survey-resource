...
- [Dimensional Analysis / Scale / Support](00-foundations/dimensional-analysis-scale-support.md)

## II. ML / DL / Scientific Computing
- [ML/DL 总览](01-ml-dl-scientific-computing/index.md)
- [Classical ML Scientific Baselines](01-ml-dl-scientific-computing/classical-ml-scientific-baselines.md)
- [Deep Learning Architectures](01-ml-dl-scientific-computing/deep-learning-architectures.md)
- [Transformer / GNN for Science](01-ml-dl-scientific-computing/transformer-gnn-for-science.md)
- [PyTorch / JAX / HPC Basics](01-ml-dl-scientific-computing/pytorch-jax-hpc-basics.md)

## III. Physical AI Core / Scientific ML
- [Physical AI Core](02-physics-ai-core/index.md)
- [Observation Operators](02-physics-ai-core/observation-operators.md)
- [Conservation / Symmetry / Dimensional Priors](02-physics-ai-core/conservation-symmetry-dimensional-priors.md)
- [Hybrid Modeling Design](02-physics-ai-core/hybrid-modeling-design.md)
- [Physics-informed Learning](03-physics-informed-learning/index.md)
- [PINN Fundamentals](03-physics-informed-learning/pinn-fundamentals.md)
- [PINN Optimization / Failure Modes](03-physics-informed-learning/pinn-optimization-failure-modes.md)
- [Hard / Soft Constraints](03-physics-informed-learning/hard-soft-constraints.md)
- [Neural Operators & Simulation](04-neural-operators-simulation/index.md)
- [Neural Operator Family](04-neural-operators-simulation/neural-operator-family.md)
...
## V. Spatiotemporal / Multiscale / Multimodal
- [Spatiotemporal & Multiscale AI](05-spatiotemporal-multiscale-ai/index.md)
- [Spatial Representations](05-spatiotemporal-multiscale-ai/spatial-representations.md)
- [Temporal Modeling](05-spatiotemporal-multiscale-ai/temporal-modeling.md)
- [Multiscale / Multimodal Fusion](05-spatiotemporal-multiscale-ai/multiscale-multimodal-fusion.md)
- [Support-aware Learning](05-spatiotemporal-multiscale-ai/support-aware-learning.md)
...
- [EO Foundation Models](06-earth-observation-ai/eo-foundation-models.md)
- [Geospatial Validation / OOD](06-earth-observation-ai/geospatial-validation.md)
...
- [Flux Footprints](07-carbon-cycle-ai/flux-footprints.md)
- [Carbon Data Stack](07-carbon-cycle-ai/carbon-data-stack.md)
- [Carbon Modeling Methods](07-carbon-cycle-ai/carbon-modeling-methods.md)
- [Carbon–Water–Energy Coupling](07-carbon-cycle-ai/carbon-water-energy-coupling.md)
- [Process-constrained Carbon AI](07-carbon-cycle-ai/process-constrained-carbon-ai.md)
- [Footprint-aware AI](07-carbon-cycle-ai/footprint-aware-ai.md)
- [Multimodal Carbon AI](07-carbon-cycle-ai/multimodal-carbon-ai.md)
- [Tower-to-grid Upscaling](07-carbon-cycle-ai/tower-to-grid-upscaling.md)
- [Extremes / Climate Response](07-carbon-cycle-ai/extremes-climate-response.md)
- [Validation / Uncertainty](07-carbon-cycle-ai/validation-uncertainty.md)
...
- [Climate AI](08-weather-climate-ai/climate-ai.md)
- [Earth-system Coupling](08-weather-climate-ai/earth-system-coupling.md)
- [Weather Foundation Models](08-weather-climate-ai/weather-foundation-models.md)
- [Weather Evaluation](08-weather-climate-ai/weather-evaluation.md)
...
- [Earth FM Evaluation](09-earth-foundation-models/earth-fm-evaluation.md)
...
- [Digital Twins bridge](12-cross-domain-physical-ai/digital-twins-embodied.md)

### XI-A. Embodied Physical AI / Robotics
- [Embodied / Robotics 总览](12-cross-domain-physical-ai/embodied-robotics/index.md)
- [Foundations / POMDP / Control Loop](12-cross-domain-physical-ai/embodied-robotics/00-foundations.md)
- [Robot Perception](12-cross-domain-physical-ai/embodied-robotics/01-perception.md)
- [Geometry / 3D / SE(3)](12-cross-domain-physical-ai/embodied-robotics/02-geometry-3d.md)
- [State Estimation / Sensor Fusion / SLAM](12-cross-domain-physical-ai/embodied-robotics/03-state-estimation.md)
- [Kinematics / Dynamics / Contact](12-cross-domain-physical-ai/embodied-robotics/04-kinematics-dynamics.md)
- [World Models / Physical Reasoning](12-cross-domain-physical-ai/embodied-robotics/05-world-models-physical-reasoning.md)
- [Planning / Control](12-cross-domain-physical-ai/embodied-robotics/06-planning-control.md)
- [Robot Learning / Data](12-cross-domain-physical-ai/embodied-robotics/07-robot-learning.md)
- [VLA / Robot Foundation Models](12-cross-domain-physical-ai/embodied-robotics/08-vla-robot-foundation-models.md)
- [Simulation / Sim-to-Real](12-cross-domain-physical-ai/embodied-robotics/09-simulation-sim2real.md)
...
→ version/date 进入 Snapshot
→ paper/code/dataset 进入 evidence layer
```

这样知识结构不会依赖具体模型名称维持完整性。
